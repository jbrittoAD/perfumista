...
| **Livros** | o ebook *Do químico aromático ao produto* — **19 livros, 48 mil palavras, 15 figuras**, mais o **audiolivro de 2,6 h** |
...
- **PDF** de 148 páginas A4 (`build_pdf.sh`);
...
knowledge/
  ebook/        os 19 livros, as figuras e as narrações do audiolivro
