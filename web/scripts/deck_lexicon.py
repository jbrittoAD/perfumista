...
PHOTO_KEYS = [
    ...
    P("cereja", "Cereja", "🍒", ["#de5f6e", "#43101a"], "sweet cherries bowl ripe", ["cherry", "cereja", "benzaldehyde", "benzaldeido"]),
    P("ameixa", "Ameixa", "🟣", ["#a5709a", "#2f1330"], "plums Prunus domestica ripe purple", ["plum", "ameixa", "prune", "damascone"]),
    ...
    P("acafrao", "Açafrão", "🧡", ["#e0913f", "#4c2409"], "saffron Crocus sativus stigmas threads", ["saffron", "acafrao", "safranal", "safraleine"]),
    ...
    # ---- madeiras
    P("cedro", "Lascas de cedro", "🪵", ["#c08d5e", "#3a2411"], "Cedrus cedar tree branches trunk", ["cedar", "cedro", "cedryl", "cedramber", "vertofix"]),
    P("sandalo", "Sândalo", "🪵", ["#d8b98a", "#453218"], "sandalwood Santalum logs powder", ["sandalwood", "sandalo", "santalol", "javanol", "polysantol", "ebanol"]),
    ...
    P("madeira-seca", "Madeira seca", "🪵", ["#b99a72", "#33230f"], "wooden planks timber boards surface", ["woody", "amadeirado", "madeira", "iso e super", "timberol", "amberwood", "cashmeran", "norlimbanol"]),
    ...
    P("terra", "Terra úmida", "🟫", ["#9a8265", "#2b1f12"], "humus soil compost close", ["earthy", "terroso", "geosmin", "beterraba", "truffle"]),
    P("oud", "Oud / agarwood", "🖤", ["#8a6a52", "#251509"], "agarwood chips incense burner", ["oud", "agarwood", "aoud"]),
    # ---- resinas / âmbar
    ...
    P("ambar-resina", "Resina de âmbar", "🟠", ["#d99a4e", "#3f2109"], "Baltic amber resin pieces fossil", ["amber", "ambar", "ambroxan", "ambrox", "labdanum", "labdano", "cistus"]),
    ...
    P("baunilha", "Fava de baunilha", "🟤", ["#c9a37a", "#33200f"], "Vanilla planifolia cured pods beans", ["vanilla", "baunilha", "vanillin", "vanilina", "ethyl vanillin", "heliotropin", "heliotropina"]),
    ...
    P("mel", "Mel escorrendo", "🍯", ["#e5b054", "#4a2c08"], "honey jar honeycomb spoon", ["honey", "mel", "phenylacetic", "beeswax"]),
